						...
						<div class="card">
							<div class="card-body">
								...
								<?php if(!empty(session()->getFlashdata('invalid'))): ?>
									<div style="background-color: red; color: white; text-align:center; padding: 5px; margin-bottom: 10px">
								...
								<?php endif; ?>
									<form action="/auth/loginUser" method="post">
										...
										<div class="mb-3">
											...
											<input class="form-control form-control-lg" type="text" name="email" value="<?= set_value('email') ?>" placeholder="Enter your email" />
